...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js7');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/ikedamap-420-1.jpg':'images/ikedamap-210-1.jpg');
var e=document.querySelector('.js3');e.setAttribute('src',(dpi>1)?'images/harvardlogo-140-1.jpg':'images/harvardlogo-70-1.jpg');
var e=document.querySelector('.js4');e.setAttribute('src',(dpi>1)?'images/hurricane-420-1.jpg':'images/hurricane-210-1.jpg');
var e=document.querySelector('.js5');e.setAttribute('src',(dpi>1)?'images/smallnn-420-1.jpg':'images/smallnn-210-1.jpg');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
initMenu($('#m2')[0]);
ldsrc('.js6');ldsrcset('.js9 source');ldsrc('.js7');ldsrcset('.js10 source');ldsrc('.js8');
});